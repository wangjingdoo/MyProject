...
public class Main_TDCS_GIDSequence_MRE_24Hour_Off {
	...
	public static void main(String[] args) throws Exception {
		...
		String TargetGantryID = "03F1779S"; // 想要觀察的匝道
		...
		job.setJarByClass(Main_TDCS_GIDSequence_MRE_24Hour_Off.class);
		// TODO: specify a mapper
		//job.setMapperClass(Mapper_TDCS_GIDSequence_MRE_24Hour_SpecificGantryID_Weekday.class);
		
		//{下交流道}： (Target)
		job.setMapperClass(Mapper_TDCS_GIDSequence_MRE_24Hour_SpecificGantryID_Weekday_Off.class);
		...
		Path outputPath = new Path(hdfs.getWorkingDirectory().toString() + "/"+InputDir+"_"+TargetGantryID+"_VehicleType_Date_Weekday_24Hour_Off");
